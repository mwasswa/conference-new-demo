...
import com.goodreason.conferencenewdemo.repositories.SessionRepository;
...
public class SessionsController {
   ...
   //@ResponseStatus(HttpStatus.CREATED)
    ...
    public void delete(@PathVariable Long id){
        //TODO: As homework, look into how to delete the children records that the session may have
